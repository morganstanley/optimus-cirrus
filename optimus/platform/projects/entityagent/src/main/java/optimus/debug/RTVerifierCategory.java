...
public class RTVerifierCategory {
  ...
  // currently hidden in reports and dashboards, as not an RT violation
  // until we introduce multi-tenancy
  ...
  public static final String NODE_WITH_CAPTURED_FSM = "NODE_WITH_CAPTURED_FSM";

  /** UI specific violations * */
