...
/**
 * Rewrites bytecode that calls a method to call a different one and reports if any changes were
 * applied.
 */
public final class MethodRewriteVisitor extends ClassVisitor {
  ...
  public MethodRewriteVisitor(
      ClassVisitor cv, String fromClass, String fromMethod, String toClass, String toMethod) {
    super(ASM9, cv);
