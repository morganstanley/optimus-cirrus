...
public interface MonitorAgent extends Iterable<Monitor> {
    
    public <E extends Monitor> E getMonitor(String monitorID, Class<E> expectedType);
    
    public void putMonitor(Monitor m);
    ...
    public void setConfiguration(List<MonitorDescriptor> configuration);
}
