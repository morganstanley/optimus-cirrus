...
/**
 * Utility class for reading values from an input stream. Copied here to break dependency on Mongo
 * driver.
 */
public class Bits {

  /**
   * Reads bytes from the input stream and puts them into the given byte buffer. The equivalent of
   * calling {@link #readFully(java.io.InputStream, byte[], int, int)} with an offset of zero and a
   * length equal to the length of the buffer.
   *
  ...
  /**
   * Reads bytes from the input stream and puts them into the given byte buffer. The equivalent of
   * calling {@link #readFully(java.io.InputStream, byte[], int, int)} with an offset of zero.
   *
   * @param in the input stream to read from
   * @param b the buffer into which the data is read.
  ...
  /**
   * Reads and returns a single integer value from the buffer. The equivalent of calling {@link
   * #readInt(byte[], int)} with an offset of zero.
   *
  ...
  /**
   * Reads and returns a single long value from the buffer. The equivalent of called {@link
   * #readLong(byte[], int)} with an offset of zero.
   *
   * @param data the buffer to read from
   * @return the long value
   */
