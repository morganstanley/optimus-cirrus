...
/* Modifications to this file were made by Morgan Stanley to allow for extensible parsing and to emit a specific error message.
 * Those changes can be found here: https://github.com/spray/spray-json/pull/222/files
...
// http://tools.ietf.org/html/rfc4627#section-2.3
  ...
  protected final def fail(
    ...
    val summary = {
      ...
      s"$preamble\nUnexpected $unexpected at input index $cursor (line $lineNr, position $col), expected $expected"
    }
    val detail = {
