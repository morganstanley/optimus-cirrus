...
trait ProductFormatsInstances { self: ProductFormats with StandardFormats =>
  ...
  def jsonFormat[P1: JF, T <: Product](construct: (P1) => T, fieldName1: String): RootJsonFormat[T] =
  ...
  def jsonFormat[P1: JF, P2: JF, T <: Product](
      construct: (P1, P2) => T,
      fieldName1: String,
  ...
  def jsonFormat3[P1: JF, P2: JF, P3: JF, T <: Product: ClassTag](construct: (P1, P2, P3) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, T <: Product](
      construct: (P1, P2, P3) => T,
      fieldName1: String,
      fieldName2: String,
      fieldName3: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(3 * 4)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat4[P1: JF, P2: JF, P3: JF, P4: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, T <: Product](
      construct: (P1, P2, P3, P4) => T,
      fieldName1: String,
      fieldName2: String,
      fieldName3: String,
      fieldName4: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(4 * 5)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat5[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, T <: Product](
      construct: (P1, P2, P3, P4, P5) => T,
      fieldName1: String,
      fieldName2: String,
      fieldName3: String,
      fieldName4: String,
      fieldName5: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(5 * 6)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat6[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5, p6) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5, p6)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, T <: Product](
      ...
      fieldName4: String,
      fieldName5: String,
      fieldName6: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(6 * 7)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat7[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5, p6, p7) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5, p6, p7)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, T <: Product](
      ...
      fieldName5: String,
      fieldName6: String,
      fieldName7: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(7 * 8)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat8[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, P8: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5, p6, p7, p8) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5, p6, p7, p8)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, P8: JF, T <: Product](
      ...
      fieldName6: String,
      fieldName7: String,
      fieldName8: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
      fields.sizeHint(8 * 9)
      fields ++= productElement2Field[P1](fieldName1, p, 0)
  ...
  def jsonFormat9[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, P8: JF, P9: JF, T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5, p6, p7, p8, p9) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5, p6, p7, p8, p9)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, P8: JF, P9: JF, T <: Product](
      ...
      fieldName7: String,
      fieldName8: String,
      fieldName9: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat10[
      ...
      P9: JF,
      P10: JF,
      T <: Product: ClassTag](construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => T): RootJsonFormat[T] = {
    val Array(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10) = extractFieldNames(classTag[T])
    jsonFormat(construct, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10)
  }
  def jsonFormat[P1: JF, P2: JF, P3: JF, P4: JF, P5: JF, P6: JF, P7: JF, P8: JF, P9: JF, P10: JF, T <: Product](
      ...
      fieldName8: String,
      fieldName9: String,
      fieldName10: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat11[
      ...
      P10: JF,
      P11: JF,
      T <: Product: ClassTag](construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat12[
      ...
      P12: JF,
      T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat13[
      ...
      P13: JF,
      T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat14[
      ...
      P14: JF,
      T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat15[
      ...
      P15: JF,
      T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat[
      ...
      fieldName13: String,
      fieldName14: String,
      fieldName15: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat16[
      ...
      P16: JF,
      T <: Product: ClassTag](
      construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16) => T): RootJsonFormat[T] = {
  ...
  def jsonFormat[
      ...
      fieldName14: String,
      fieldName15: String,
      fieldName16: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat[
      ...
      fieldName15: String,
      fieldName16: String,
      fieldName17: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat[
      ...
      fieldName17: String,
      fieldName18: String,
      fieldName19: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat[
      ...
      fieldName18: String,
      fieldName19: String,
      fieldName20: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
  ...
  def jsonFormat[
      ...
      fieldName19: String,
      fieldName20: String,
      fieldName21: String): RootJsonFormat[T] = new RootJsonFormat[T] {
    def write(p: T) = {
      val fields = new collection.mutable.ListBuffer[(String, JsValue)]
