...
trait RelationElementSerialization extends ProtoSerialization {
  implicit val relationElementSerializer: RelationElementSerializer.type = RelationElementSerializer
}
