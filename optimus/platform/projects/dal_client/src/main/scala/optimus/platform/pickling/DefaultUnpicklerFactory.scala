...
class DefaultUnpicklerFactory extends UnpicklerFactory with DefaultFactory[Unpickler] {
  ...
  override protected lazy val values: Map[ClassKey, List[Type] => Option[Unpickler[_]]] = Map(
    ...
    classKeyOf[collection.Seq[_]] -> typeParams1(t => seqUnpickler(t.unpickler)(t.manifest)),
    classKeyOf[immutable.Seq[_]] -> typeParams1(t => iseqUnpickler(t.unpickler)(t.manifest)),
    classKeyOf[collection.IndexedSeq[_]] -> typeParams1(t => indexedSeqUnpickler(t.unpickler)(t.manifest)),
    classKeyOf[immutable.IndexedSeq[_]] -> typeParams1(t => iindexedSeqUnpickler(t.unpickler)(t.manifest)),
