  ...
  implicit val metaBaseMetaDataProtocol: RootJsonFormat[MetaBaseMetaData] = new RootJsonFormat[MetaBaseMetaData] {
      ...
      jsObject.getFields("fullClassName", "packageName", "owner", "catalogClass") match {
        case Seq(fullClassName, packageName, owner, catalogClass) =>
          MetaBaseMetaData(
            ...
            controlsClass = convertTo[String](jsObject, "controlClass", ""),
            description = convertTo[String](jsObject, "description", ""),
            upstreamDatasetClass = convertTo[String](jsObject, "upstreamDatasetClass", ""),
    ...
    override def write(obj: MetaBaseMetaData): JsValue = JsObject(
      List(
        ...
        skipIfDefault[String](obj.controlsClass, "").map("controlClass" -> _.toJson),
        skipIfDefault[String](obj.description, "").map("description" -> _.toJson),
        skipIfDefault[String](obj.upstreamDatasetClass, "").map("upstreamDatasetClass" -> _.toJson),
