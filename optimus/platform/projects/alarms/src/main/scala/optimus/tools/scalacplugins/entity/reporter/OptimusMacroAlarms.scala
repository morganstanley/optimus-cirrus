...
trait OptimusMacroAlarmHelper { self: OptimusMacroAlarmsBase =>
  def error0(sn: Int, template: String): OptimusMacroAlarmBuilder0 = {
    register(OptimusMacroAlarmBuilder0(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error1(sn: Int, template: String): OptimusMacroAlarmBuilder1 = {
    register(OptimusMacroAlarmBuilder1(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error2(sn: Int, template: String): OptimusMacroAlarmBuilder2 = {
    register(OptimusMacroAlarmBuilder2(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error3(sn: Int, template: String): OptimusMacroAlarmBuilder3 = {
    register(OptimusMacroAlarmBuilder3(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error4(sn: Int, template: String): OptimusMacroAlarmBuilder4 = {
    register(OptimusMacroAlarmBuilder4(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error5(sn: Int, template: String): OptimusMacroAlarmBuilder5 = {
    register(OptimusMacroAlarmBuilder5(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def error6(sn: Int, template: String): OptimusMacroAlarmBuilder6 = {
    register(OptimusMacroAlarmBuilder6(alarmId(sn, OptimusAlarmType.ERROR), macroType, mandatory = true, template))
  }

  def info0(sn: Int, template: String): OptimusMacroAlarmBuilder0 = {
    register(OptimusMacroAlarmBuilder0(alarmId(sn, OptimusAlarmType.INFO), macroType, mandatory = true, template))
  }

  def warning0(sn: Int, template: String): OptimusMacroAlarmBuilder0 = {
    register(OptimusMacroAlarmBuilder0(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = true, template))
  }

  def warningOptional0(sn: Int, template: String): OptimusMacroAlarmBuilder0 = {
    register(OptimusMacroAlarmBuilder0(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = false, template))
  }

  def warning1(sn: Int, template: String): OptimusMacroAlarmBuilder1 = {
    register(OptimusMacroAlarmBuilder1(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = true, template))
  }

  def warningOptional1(sn: Int, template: String): OptimusMacroAlarmBuilder1 = {
    register(OptimusMacroAlarmBuilder1(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = false, template))
  }

  def warning2(sn: Int, template: String): OptimusMacroAlarmBuilder2 = {
    register(OptimusMacroAlarmBuilder2(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = true, template))
  }

  def warningOptional2(sn: Int, template: String): OptimusMacroAlarmBuilder2 = {
    register(OptimusMacroAlarmBuilder2(alarmId(sn, OptimusAlarmType.WARNING), macroType, mandatory = false, template))
  }

  def abort0(sn: Int, template: String): OptimusMacroAlarmBuilder0 = {
    register(OptimusMacroAlarmBuilder0(alarmId(sn, OptimusAlarmType.ABORT), macroType, mandatory = true, template))
  }

  def abort1(sn: Int, template: String): OptimusMacroAlarmBuilder1 = {
    register(OptimusMacroAlarmBuilder1(alarmId(sn, OptimusAlarmType.ABORT), macroType, mandatory = true, template))
  }

  def abort2(sn: Int, template: String): OptimusMacroAlarmBuilder2 = {
    register(OptimusMacroAlarmBuilder2(alarmId(sn, OptimusAlarmType.ABORT), macroType, mandatory = true, template))
  }

  def abortOptional2(sn: Int, template: String): OptimusMacroAlarmBuilder2 = {
    register(OptimusMacroAlarmBuilder2(alarmId(sn, OptimusAlarmType.ABORT), macroType, mandatory = false, template))
  }
...
abstract class OptimusMacroAlarmBuilder(val id: AlarmId, val tpe: OptimusMacroType, val template: String)
  ...
  final protected def buildImpl0(mandatory: Boolean): OptimusMacroAlarm = OptimusMacroAlarm(id, tpe, template, template)
  final protected def buildImpl(mandatory: Boolean, args: String*): OptimusMacroAlarm =
...
case class OptimusMacroAlarmBuilder6(
  ...
  def apply(arg1: Any, arg2: Any, arg3: Any, arg4: Any, arg5: Any, arg6: Any) =
    buildImpl(mandatory, arg1.toString, arg2.toString, arg3.toString, arg4.toString, arg5.toString, arg6.toString)
}
