...
public abstract class DirectoryEntryBase implements DirectoryEntry {
  ...
  protected static final int statusLength =
      NumConversion.BYTES_PER_SHORT + 2; /* 2 is padding to match C alignment */
  protected static final int versionLength = NumConversion.BYTES_PER_LONG;

  protected static final int magicOffset = 0;
  protected static final int sizeOffset =
      magicOffset + magicLength; // size is name length + terminator + alignment
