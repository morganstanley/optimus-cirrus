...
/**
 * Wraps a ServerSocketChannel with a ChannelRegistrationWorker so that ChannelRegistrationWorker
 * can be informed when this channel is registered.
 */
final class NewServerSocketChannel {
  private final ServerSocketChannel serverSocketChannel;
  private final ChannelRegistrationWorker channelRegistrationWorker;

  public NewServerSocketChannel(
