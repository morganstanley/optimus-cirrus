...
public abstract class RetrievalException extends KeyedOperationException {
  ...
  protected RetrievalException(Map<Object, OperationState> operationState, Map<Object, FailureCause> failureCause,
      Map<Object, StoredValue> partialResults) {
    super(operationState, failureCause);
    this.partialResults = partialResults;
  }

  protected RetrievalException(String message, Map<Object, OperationState> operationState,
      Map<Object, FailureCause> failureCause, Map<Object, StoredValue> partialResults) {
    super(message, operationState, failureCause);
    this.partialResults = partialResults;
  }

  protected RetrievalException(String message, Throwable cause, Map<Object, OperationState> operationState,
      Map<Object, FailureCause> failureCause, Map<Object, StoredValue> partialResults) {
    super(message, cause, operationState, failureCause);
    this.partialResults = partialResults;
  }

  protected RetrievalException(Throwable cause, Map<Object, OperationState> operationState,
      Map<Object, FailureCause> failureCause, Map<Object, StoredValue> partialResults) {
