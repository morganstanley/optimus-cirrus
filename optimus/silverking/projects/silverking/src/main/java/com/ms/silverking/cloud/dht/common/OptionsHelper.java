...
public class OptionsHelper {
  ...
  public static RetrievalOptions newRetrievalOptions(RetrievalType retrievalType, WaitMode waitMode,
      VersionConstraint versionConstraint, NonExistenceResponse nonExistenceResponse, boolean verifyChecksums) {
    return new RetrievalOptions(waitMode == WaitMode.GET ?
        DHTConstants.standardTimeoutController :
        DHTConstants.standardWaitForTimeoutController, DHTConstants.noSecondaryTargets, retrievalType, waitMode,
        versionConstraint, nonExistenceResponse, verifyChecksums, false, ForwardingMode.FORWARD, false);
  }
  ...
  public static GetOptions newGetOptions(OpTimeoutController opTimeoutController, RetrievalType retrievalType,
      VersionConstraint versionConstraint) {
    return new GetOptions(opTimeoutController, DHTConstants.noSecondaryTargets, retrievalType, versionConstraint,
        NonExistenceResponse.defaultResponse, true, false, ForwardingMode.FORWARD, false);
  }
  ...
  /**
   * Construct fully-specified static WaitOptions newWaitOptions except for OpTimeoutController which will use the
   * default.
   *
  ...
  public static WaitOptions newWaitOptions(RetrievalType retrievalType, VersionConstraint versionConstraint,
    ...
    return new WaitOptions(DHTConstants.standardWaitForTimeoutController, DHTConstants.noSecondaryTargets,
        retrievalType, versionConstraint, NonExistenceResponse.defaultResponse, true, false, false, timeoutSeconds,
        threshold, timeoutResponse);
  }

  /**
   * Construct static WaitOptions newWaitOptions with timeoutResponse set to the default of throwing an exception
   * upon timeout.
   *
   * @param retrievalType     what to retrieve (data, meta data, etc.)
   * @param versionConstraint filter on the allowed versions
  ...
  /**
   * Construct static WaitOptions newWaitOptions specifying to wait forever until all values are returned, and
   * using the
  ...
  /**
   * Construct static WaitOptions newWaitOptions for RetrievalType.VALUE specifying to wait forever until all values
   * are returned,
...
//
  ...
  public static PutOptions newPutOptions(byte[] userData, byte[] authorizationUser) {
    PutOptions putOptions = DHTConstants.standardPutOptions
        .userData(userData)
  ...
  public static NamespaceOptions newNamespaceOptions(StorageType storageType, ConsistencyProtocol consistencyProtocol,
      NamespaceVersionMode versionMode, PutOptions defaultPutOptions, InvalidationOptions defaultInvalidationOptions,
    ...
    return new NamespaceOptions(storageType, consistencyProtocol, versionMode, DHTConstants.defaultRevisionMode,
        defaultPutOptions, defaultInvalidationOptions, defaultGetOptions, defaultWaitOptions,
        DHTConstants.defaultSecondarySyncIntervalSeconds, DHTConstants.defaultSegmentSize,
        DHTConstants.defaultMaxValueSize, false);
  }
}
