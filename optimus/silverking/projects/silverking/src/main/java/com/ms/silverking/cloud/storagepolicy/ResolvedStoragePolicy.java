 ...
 *
 * <p>Associates a StoragePolicy definition with primary and secondary servers.
 */
public class ResolvedStoragePolicy {
  ...
  public ResolvedStoragePolicy(
      StoragePolicy storagePolicy, List<Node> primaryServers, List<Node> secondaryServers) {
