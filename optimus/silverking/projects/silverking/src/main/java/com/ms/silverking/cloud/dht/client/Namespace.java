...
/**
 * A namespace for storing values associated with keys. All associations in this namespace are
 * distinct with respect to associations in other namespaces. NamespaceOptions are used to specify
 * how values are stored.
 *
 * <p>All values stored in a namespace are stored as sequences of bytes. NamespacePerspectives are
 * used to map types to bytes and vice versa as well as specifying the compression and checksum
 * used.
 */
public interface Namespace {
  ...
  /**
   * Open an AsynchronousNamespacePerspective for the given key, value types. Use default
   * NamespacePerspectiveOptions for this Namespace
   *
   * @param <K> key type of perspective to open
   * @param <V> value type of perspective to open
   * @param keyClass class of keys
  ...
  /**
   * Open an SynchronousNamespacePerspective for the given key, value types Use default
   * NamespacePerspectiveOptions for this Namespace
   *
   * @param <K> key type of perspective to open
   * @param <V> value type of perspective to open
  ...
  /**
   * Create a clone of this namespace. For user-defined versioned namespaces, the version of this
   * method that accepts a version must be used.
   *
  ...
  /**
   * Create a clone of this namespace. This version of this method is for use with user-defined
   * versioning only.
   *
   * @param name name of the child namespace
   * @param version the version at which to create the clone. Must be greater than any version of
   *     any value currently stored in the namespace.
   * @return the child namespace
   * @throws NamespaceCreationException TODO (OPTIMUS-0000): describe
   */
  ...
  /**
   * <b>WARNING: This method is provided for backwards compatibility to SilverRails. Use of this
   * method is not recommended. clone() is recommended instead.</b>
   *
   * <p>Link this namespace as a child of a provided target namespace. May only be used with
   * write-once versioned namespaces. This namespace must be set to allow links. The target
   * namespace must already exist and must have identical options to this namespace.
   *
  ...
  /**
   * Name of the Replicas namespace. The Replicas namespace provides the locations of replicas given
   * a key
   */
  public static final String replicasName = "__Replicas__";
  /**
   * Name of the Node namespace. The Node namespace provides information about the node answering
   * the query such as "bytesFree"
   */
  public static final String nodeName = "__Node__";
  /**
   * Name of the System namespace. The System namespace provides information about the overall SK
   * instance.
   */
