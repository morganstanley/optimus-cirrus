...
import com.ms.silverking.cloud.dht.trace.Tracer;
import com.ms.silverking.id.UUIDBase;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class AsyncSendListenerWithTracerImpl implements AsyncSendListener {

  private static Logger log = LoggerFactory.getLogger(AsyncSendListenerWithTracerImpl.class);

  private String traceIdStr;
  private Tracer tracer;

  public AsyncSendListenerWithTracerImpl(String traceIdStr, Tracer tracer) {
  ...
  public void timeout(UUIDBase uuid, long lastPollTime, long currPollTime, int currQueueSize, long creationTime, long deadline, long currTime) {
    ...
    tracer.onAsyncSendTimeout(uuid, traceIdStr, lastPollTime, currPollTime, currQueueSize, creationTime, deadline, currTime);
  }
