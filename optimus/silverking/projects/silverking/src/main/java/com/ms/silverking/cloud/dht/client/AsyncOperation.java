...
public interface AsyncOperation {
  ...
  /**
   * Close this asynchronous operation. No subsequent calls may be issued against this reference.
   */
  public void close();
   ...
   * OperationState.SUCCEEDED, OperationState.FAILED) This operation will notify this listener at
   * most once.
   *
   ...
   * immediately executed, possibly in the calling thread. If OperationState.INCOMPLETE is in
   * listenStates, the listener may be notified multiple times, and the listener must be prepared
   * for this. If INCOMPLETE is not specified, then this operation will notify the listener at most
   * once.
   *
   ...
   * addListeners(listeners, OperationState.SUCCEEDED, OperationState.FAILED) This operation will
   * notify this listener at most once.
   *
  ...
  /**
   * Adds multiple completion listeners. For any listener that is already complete, the callback
   * will be immediately executed, possibly in the calling thread. If OperationState.INCOMPLETE is
   * in listenStates, the listener may be notified multiple times, and the listener must be prepared
   * for this. If INCOMPLETE is not specified, then this operation will notify the listener at most
   * once.
   *
   * @param listeners update listeners
  ...
  public void addListeners(
      Iterable<AsyncOperationListener> listeners, OperationState... listenStates);
}
