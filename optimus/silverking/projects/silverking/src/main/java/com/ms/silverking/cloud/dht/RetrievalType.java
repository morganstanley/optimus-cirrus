...
/**
 * Specifies the type of retrieval operation to perform. Types that do not specify value retrieval
 * are guaranteed to not retrieve the value. The EXISTENCE operation returns StoredValues that are
 * non-null if the given mapping exists and null otherwise. All retrievals may optionally fetch meta
 * data whether or not it is specified, but this not guaranteed to exist.
 */
