 ...
 *
 * @author Chris Nokleberg // regex-ignore-line allowed by license citation convention
 */
abstract class WrappingExecutorService implements ExecutorService {
   ...
   * to any {@code Runnable} passed to the default implementation of {@link #wrapTest(Runnable)}.
   */
