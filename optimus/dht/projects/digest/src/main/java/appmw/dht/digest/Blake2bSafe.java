...
import static appmw.dht.digest.Blake2bSafe.Engine.Assert.*;
import static appmw.dht.digest.Blake2bSafe.Engine.LittleEndian.*;
...
public interface Blake2bSafe {
  ...
  public static final class ResumeHandle implements Serializable {
     ...
     * @return
     */
    public Blake2bSafe resume(Param param) {
  ...
  public static class Digest extends Engine implements Blake2bSafe {
  ...
  public static class Mac extends Engine implements Blake2bSafe {
  ...
  // Engine
  // ---------------------------------------------------------------------
  static class Engine implements Blake2bSafe {
    ...
    public static void main(String... args) {
      Blake2bSafe mac = Blake2bSafe.Mac.newInstance("LOVE".getBytes());
    ...
    public static class Debug {
      public static void dumpState(Blake2bSafe.Engine e, final String mark) {
